...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface IAccountExecuteInterface extends Interface {
    ...
    encodeFunctionData(functionFragment: 'executeUserOp', values: [PackedUserOperationStruct, BytesLike]): string;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    getFunction(nameOrSignature: 'executeUserOp'): TypedContractMethod<
      [userOp: PackedUserOperationStruct, userOpHash: BytesLike, ],
      [void],
      'nonpayable'
    >;
