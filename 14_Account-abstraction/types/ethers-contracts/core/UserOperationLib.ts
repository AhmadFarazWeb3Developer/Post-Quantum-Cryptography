...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface UserOperationLibInterface extends Interface {
    getFunction(nameOrSignature: "PAYMASTER_DATA_OFFSET" | "PAYMASTER_POSTOP_GAS_OFFSET" | "PAYMASTER_VALIDATION_GAS_OFFSET"): FunctionFragment;
...
decodeFunctionResult(functionFragment: 'PAYMASTER_VALIDATION_GAS_OFFSET', data: BytesLike): Result;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    PAYMASTER_DATA_OFFSET: TypedContractMethod<
      [],
      [bigint],
      'view'
    >
    ...
    PAYMASTER_POSTOP_GAS_OFFSET: TypedContractMethod<
      [],
      [bigint],
      'view'
    >
    ...
    PAYMASTER_VALIDATION_GAS_OFFSET: TypedContractMethod<
      [],
      [bigint],
      'view'
    >
    ...
    getFunction(nameOrSignature: 'PAYMASTER_DATA_OFFSET'): TypedContractMethod<
      [],
      [bigint],
      'view'
    >;
getFunction(nameOrSignature: 'PAYMASTER_POSTOP_GAS_OFFSET'): TypedContractMethod<
      [],
      [bigint],
      'view'
    >;
getFunction(nameOrSignature: 'PAYMASTER_VALIDATION_GAS_OFFSET'): TypedContractMethod<
      [],
      [bigint],
      'view'
    >;
