...
encodeFunctionData(functionFragment: 'falconPublicKey', values?: undefined): string;
...
decodeFunctionResult(functionFragment: 'falconPublicKey', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'withdrawDepositTo', data: BytesLike): Result;
    ...
    export namespace SimpleAccountInitializedEvent {
      ...
      export interface OutputObject {entryPoint: string, owner: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    falconPublicKey: TypedContractMethod<
      [],
      [string],
      'view'
    >
...
getFunction(nameOrSignature: 'executeBatch'): TypedContractMethod<
      ...
      'nonpayable'
    >;
getFunction(nameOrSignature: 'falconPublicKey'): TypedContractMethod<
      [],
      [string],
      'view'
    >;
