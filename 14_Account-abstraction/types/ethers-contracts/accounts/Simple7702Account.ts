...
export declare namespace BaseAccount {
    ...
    export type CallStruct = {target: AddressLike, value: BigNumberish, data: BytesLike}

    export type CallStructOutput = [target: string, value: bigint, data: string] & {target: string, value: bigint, data: string }
  
    }

  export interface Simple7702AccountInterface extends Interface {
    getFunction(nameOrSignature: "entryPoint" | "execute" | "executeBatch" | "getNonce" | "isValidSignature" | "onERC1155BatchReceived" | "onERC1155Received" | "onERC721Received" | "supportsInterface" | "validateUserOp"): FunctionFragment;
...
encodeFunctionData(functionFragment: 'executeBatch', values: [BaseAccount.CallStruct[]]): string;
...
decodeFunctionResult(functionFragment: 'validateUserOp', data: BytesLike): Result;
  ...
  export interface Simple7702Account extends BaseContract {
    
    connect(runner?: ContractRunner | null): Simple7702Account;
    waitForDeployment(): Promise<this>;

    interface: Simple7702AccountInterface;
