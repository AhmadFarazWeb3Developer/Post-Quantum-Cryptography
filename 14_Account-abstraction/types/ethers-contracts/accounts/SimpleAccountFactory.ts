...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface SimpleAccountFactoryInterface extends Interface {
    getFunction(nameOrSignature: "accountImplementation" | "createAccount" | "getAddress" | "senderCreator"): FunctionFragment;
...
decodeFunctionResult(functionFragment: 'senderCreator', data: BytesLike): Result;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    accountImplementation: TypedContractMethod<
      [],
      [string],
      'view'
    >
    ...
    getFunction(nameOrSignature: 'accountImplementation'): TypedContractMethod<
      [],
      [string],
      'view'
    >;
