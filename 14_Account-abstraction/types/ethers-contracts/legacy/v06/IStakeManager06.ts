...
export declare namespace IStakeManager06 {
  ...
  export interface IStakeManager06Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'withdrawTo', data: BytesLike): Result;
  ...
  export interface IStakeManager06 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IStakeManager06;
    waitForDeployment(): Promise<this>;

    interface: IStakeManager06Interface;
