...
encodeFunctionData(functionFragment: 'validatePaymasterUserOp', values: [UserOperation06Struct, BytesLike, BigNumberish]): string;
...
decodeFunctionResult(functionFragment: 'validatePaymasterUserOp', data: BytesLike): Result;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    validatePaymasterUserOp: TypedContractMethod<
      [userOp: UserOperation06Struct, userOpHash: BytesLike, maxCost: BigNumberish, ],
