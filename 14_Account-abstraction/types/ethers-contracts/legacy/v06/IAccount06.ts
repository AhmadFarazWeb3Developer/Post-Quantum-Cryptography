...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IAccount06Interface extends Interface {
    ...
    encodeFunctionData(functionFragment: 'validateUserOp', values: [UserOperation06Struct, BytesLike, BigNumberish]): string;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    validateUserOp: TypedContractMethod<
      [userOp: UserOperation06Struct, userOpHash: BytesLike, missingAccountFunds: BigNumberish, ],
      [bigint],
      'nonpayable'
    >
