...
export declare namespace IEntryPoint {
    ...
    export type UserOpsPerAggregatorStruct = {userOps: UserOperation06Struct[], aggregator: AddressLike, signature: BytesLike}

    export type UserOpsPerAggregatorStructOutput = [userOps: UserOperation06StructOutput[], aggregator: string, signature: string] & {userOps: UserOperation06StructOutput[], aggregator: string, signature: string }
  
    }

  export interface IEntryPointInterface extends Interface {
    getFunction(nameOrSignature: "addStake" | "balanceOf" | "depositTo" | "getDepositInfo" | "getNonce" | "getSenderAddress" | "getUserOpHash" | "handleAggregatedOps" | "handleOps" | "incrementNonce" | "simulateHandleOp" | "simulateValidation" | "unlockStake" | "withdrawStake" | "withdrawTo"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "AccountDeployed" | "BeforeExecution" | "Deposited" | "SignatureAggregatorChanged" | "StakeLocked" | "StakeUnlocked" | "StakeWithdrawn" | "UserOperationEvent" | "UserOperationRevertReason" | "Withdrawn"): EventFragment;
...
encodeFunctionData(functionFragment: 'getUserOpHash', values: [UserOperation06Struct]): string;
encodeFunctionData(functionFragment: 'handleAggregatedOps', values: [IEntryPoint.UserOpsPerAggregatorStruct[], AddressLike]): string;
encodeFunctionData(functionFragment: 'handleOps', values: [UserOperation06Struct[], AddressLike]): string;
encodeFunctionData(functionFragment: 'incrementNonce', values: [BigNumberish]): string;
encodeFunctionData(functionFragment: 'simulateHandleOp', values: [UserOperation06Struct, AddressLike, BytesLike]): string;
encodeFunctionData(functionFragment: 'simulateValidation', values: [UserOperation06Struct]): string;
...
decodeFunctionResult(functionFragment: 'withdrawTo', data: BytesLike): Result;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    getDepositInfo: TypedContractMethod<
      [account: AddressLike, ],
      [IStakeManager06.DepositInfoStructOutput],
      'view'
    >
    ...
    handleOps: TypedContractMethod<
      [ops: UserOperation06Struct[], beneficiary: AddressLike, ],
      [void],
      'nonpayable'
    >
    ...
    simulateHandleOp: TypedContractMethod<
      [op: UserOperation06Struct, target: AddressLike, targetCallData: BytesLike, ],
      [void],
      'nonpayable'
    >
