...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface INonceManager06Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'incrementNonce', data: BytesLike): Result;
  ...
  export interface INonceManager06 extends BaseContract {
    
    connect(runner?: ContractRunner | null): INonceManager06;
    waitForDeployment(): Promise<this>;

    interface: INonceManager06Interface;
